...
const ALIGN = [
  ...
  { letter: 'L', word: 'Linkage',        desc: 'Coordinating existing capacity rather than duplicating it across the ecosystem.' },
  { letter: 'I', word: 'Intentionality', desc: 'Purpose-driven partnerships that map to real systemic outcomes.' },
  { letter: 'G', word: 'Governance',     desc: "Building platforms that scale with Africa's evolving impact infrastructure." },
    ...
    <div style={{
      ...
      <div className="hp-feature-row-grid" style={{
        ...
        <div style={{ order: feat.flip ? 2 : 1, maxWidth: '520px' }}>
          ...
          <p style={{ fontSize: '0.8125rem', fontStyle: 'italic', color: isDark ? 'rgba(247,243,237,0.38)' : 'rgba(20,17,13,0.45)', marginBottom: '1.125rem', letterSpacing: '0.01em' }}>
            {feat.sub}
          </p>
          <p style={{ fontSize: '1rem', color: isDark ? 'rgba(247,243,237,0.55)' : 'rgba(20,17,13,0.6)', lineHeight: 1.75, maxWidth: '440px' }}>
            {feat.desc}
          </p>
        </div>
        {/* Image */}
              ...
              <div className="hp-roles-grid" style={{ display: 'grid', gridTemplateColumns: '1fr clamp(200px, 28vw, 340px)', gap: '3rem', alignItems: 'center' }}>
                <div style={{ maxWidth: '640px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem', marginBottom: '1.75rem' }}>
                    ...
                    <span style={{ fontSize: '0.6875rem', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase', color: isDark ? 'rgba(247,243,237,0.38)' : 'rgba(20,17,13,0.45)' }}>
                      {item.role}
                    </span>
                  </div>
                  <h3 style={{
                  ...
                  <p style={{ fontSize: '1rem', lineHeight: 1.75, color: isDark ? 'rgba(247,243,237,0.52)' : 'rgba(20,17,13,0.6)', maxWidth: '500px', marginBottom: '2rem' }}>
                    {item.desc}
                  </p>
...
export default function HomePage() {
  ...
  const T = {
    ...
    text:       isDark ? '#f7f3ed'                   : '#14110d',
    textDim:    isDark ? 'rgba(247,243,237,0.55)'    : 'rgba(20,17,13,0.6)',
    textDimmer: isDark ? 'rgba(247,243,237,0.45)'    : 'rgba(20,17,13,0.5)',
    textFaint:  isDark ? 'rgba(247,243,237,0.38)'    : 'rgba(20,17,13,0.4)',
    border:     isDark ? 'rgba(255,255,255,0.06)'    : 'rgba(0,0,0,0.07)',
    borderMd:   isDark ? 'rgba(255,255,255,0.08)'    : 'rgba(0,0,0,0.1)',
    surface:    isDark ? 'rgba(255,255,255,0.02)'    : 'rgba(0,0,0,0.02)',
    surfaceMd:  isDark ? 'rgba(255,255,255,0.03)'    : 'rgba(0,0,0,0.03)',
    statsCard:  isDark ? 'rgba(14,12,16,0.65)'       : 'rgba(255,255,255,0.8)',
  }
  ...
  return (
    <div style={{ background: T.bg, minHeight: '100vh', color: T.text }}>
          ...
          <div className="hp-mobile-stack" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(2.5rem, 6vw, 6rem)', alignItems: 'center' }}>
            ...
            <div style={{ borderRadius: '1.25rem', border: `1px solid ${T.borderMd}`, background: T.surfaceMd, backdropFilter: 'blur(20px)', padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', justifyContent: 'center' }}>
              ...
              <div style={{ padding: '1.5rem 1.75rem', borderRadius: '0.875rem', background: 'rgba(196,92,38,0.06)', border: '1px solid rgba(196,92,38,0.18)' }}>
                <div style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: '1.25rem', fontWeight: 800, letterSpacing: '0.08em', color: '#C45C26', lineHeight: 1, marginBottom: '0.875rem' }}>
                  A.L.I.G.N.
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {ALIGN.map((item) => (
                    <div key={item.letter} style={{ display: 'flex', gap: '0.625rem', alignItems: 'flex-start' }}>
                      <span style={{ fontSize: '0.75rem', fontWeight: 800, color: '#C45C26', minWidth: '0.875rem', lineHeight: 1.6 }}>{item.letter}</span>
                      <span style={{ fontSize: '0.8125rem', color: T.textDim, lineHeight: 1.6 }}>
                        <strong style={{ color: T.text, fontWeight: 600 }}>{item.word}</strong> — {item.desc}
                      </span>
                    </div>
                  ))}
                </div>
      ...
      {/* ── CTA ───────────────────────────────────────────── */}
      <section className="hp-reveal" style={{ ...S.sectionPadSm, ...S.reveal, borderTop: `1px solid ${T.border}` }}>
