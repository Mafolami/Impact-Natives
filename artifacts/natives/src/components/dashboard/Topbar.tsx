...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/dashboard/portfolio/exchanges": "Exchanges",
  "/dashboard/portfolio/mou": "MoUs",
  "/dashboard/portfolio/milestones": "Traction",
  "/dashboard/portfolio/track-record": "Track record",
  "/dashboard/labs":          "Labs",
...
const PAGE_SUBTITLES: Record<string, string> = {
  ...
  "/dashboard/portfolio/exchanges": "Track where each initiative and partnership stands, from interest to confirmed partner.",
  "/dashboard/portfolio/mou": "Memorandums of understanding across your confirmed partnerships and initiatives.",
  "/dashboard/portfolio/milestones": "Delivery and verified outcomes across your executed agreements, tracked from commitment to disbursement.",
  "/dashboard/portfolio/track-record": "Your evidence coverage and verification history across the platform.",
...
export default function Topbar({ sidebarCollapsed }: TopbarProps) {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 right-0 h-[81px] bg-background flex items-center justify-between px-3 sm:px-6 py-2 z-30 transition-all duration-200",
    ...
    >
      <div className="flex flex-col gap-1.5 min-w-0 flex-1 mr-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h1 className="!text-[12px] sm:!text-[15px] font-bold !tracking-[0.05em] sm:!tracking-[0.14em] uppercase truncate text-[#C45C26]">
            {title}
          </h1>
        </div>
        {subtitle && <p className="text-[10px] sm:text-sm leading-tight sm:leading-normal text-black dark:text-white pl-3.5 line-clamp-3 sm:line-clamp-none">{subtitle}</p>}
      </div>
