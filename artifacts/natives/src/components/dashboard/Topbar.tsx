...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/dashboard/portfolio/milestones": "Milestones",
  "/dashboard/labs":          "Labs",
...
const PAGE_SUBTITLES: Record<string, string> = {
  ...
  "/dashboard/portfolio/milestones": "Delivery against your executed agreements, tracked from commitment to disbursement.",
