...
const WHAT_WE_OFFER = [
  ...
  },
  {
    ...
    body: "Leverage the Natives platform — coordination tools, partner matching, and lab facilitation built for Africa.",
    accent: "#1B4FD8",
  },
  {
    num: "04",
...
export default function PartnerWithNativesPage() {
  ...
  return (
    <>
      ...
      {/* ══ HERO ══════════════════════════════════════════════════════════════ */}
            <section className="pwn-hero-band" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', marginTop: '-64px', paddingTop: '64px' }}>
        <div className="w-full max-w-7xl mx-auto content-padding py-20 md:py-28" style={{ paddingTop: '8rem' }}>
          ...
          <p className="pwn-f3 pwn-hero-sub text-base md:text-lg mb-10">
            We build the connective tissue — strategic alliances, research collaborations,
          ...
          <div className="pwn-f4 flex flex-wrap items-center gap-3 mb-16">
            ...
            <Button className="pwn-hero-ghost" variant="ghost">
              Explore modalities ↓
            </Button>
          </div>
          ...
          <div className="pwn-f5 grid grid-cols-3 sm:grid-cols-3 gap-3 max-w-lg">
            {[
              ...
              <div key={s.label} className="pwn-stat-chip">
                <div className="pwn-stat-num text-lg md:text-xl">{s.num}</div>
                <div className="pwn-stat-label text-[10px]">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                We partner with a select number of organisations each year — funders, corporates,
        ...
        <div className="pwn-cta-block">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 relative z-10">
            ...
            <div className="shrink-0 flex flex-col gap-3 items-start md:items-end">
              ...
              <span className="pwn-cta-note text-xs">
                Organisational email required · 5-day response
              </span>
            </div>
          </div>
        </div>
